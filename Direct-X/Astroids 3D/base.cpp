...
bool d3d::InitD3D(HINSTANCE hInstance,int width, int height,bool windowed,D3DDEVTYPE deviceType,IDirect3DDevice9** device)
{
	...
	HWND hwnd = 0;
	hwnd = ::CreateWindow("Direct3D", "Starter Program", WS_EX_TOPMOST, 0, 0, width, height, 0, 0, hInstance, 0); 
	...
	::MessageBox(0,"Esc - Exits Game\nSpace Bar - Simulates Shooting\n"
		"Left Arrow - Maneuvers Left\nRight Arrow - Maneuvers Right\n"
		"Up Arrow - Maneuvers Up\nDown Arrow - Maneuvers Down\nA - Simulates Asteroid Hit","Instrucstions",0);
